...
void main()
{
	...
	if (u_color!=vec3(0.0)) gl_FragColor=v_vColour*vec4(u_color.r,u_color.g,u_color.b,baseCol.a);
	else if (baseCol.r>0.0&&baseCol.r<1.0) gl_FragColor=v_vColour*vec4(baseCol.r); //edge
